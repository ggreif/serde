...
<summary>bench/serde.bench.mo $({\color{green}-0.16\%})$</summary>
...
|                                     |                                  decode() |                                  encode() |
| :---------------------------------- | ----------------------------------------: | ----------------------------------------: |
| Serde: One Shot                     | 1_030_284_503 $({\color{green}-0.00\\%})$ | 2_073_858_142 $({\color{green}-0.02\\%})$ |
| Serde: One Shot sans type inference |   488_153_820 $({\color{green}-0.01\\%})$ | 1_478_201_843 $({\color{green}-0.01\\%})$ |
| Motoko (to_candid(), from_candid()) |    38_863_688 $({\color{green}-0.04\\%})$ |    11_625_896 $({\color{green}-0.05\\%})$ |
| Serde: Single Type Serializer       |   228_867_718 $({\color{green}-0.01\\%})$ |   444_230_087 $({\color{green}-0.02\\%})$ |
...
|                                     |                              decode() |                               encode() |
| :---------------------------------- | ------------------------------------: | -------------------------------------: |
| Serde: One Shot                     | 16.64 MiB $({\color{green}-0.01\\%})$ |   2.27 MiB $({\color{green}-1.08\\%})$ |
| Serde: One Shot sans type inference |  -19.57 MiB $({\color{red}+0.03\\%})$ |  11.08 MiB $({\color{green}-0.05\\%})$ |
| Motoko (to_candid(), from_candid()) |  1.16 MiB $({\color{green}-0.04\\%})$ | 666.93 KiB $({\color{green}-0.01\\%})$ |
| Serde: Single Type Serializer       | 15.85 MiB $({\color{green}-0.02\\%})$ |   -41.74 MiB $({\color{red}+0.01\\%})$ |
...
|                                     |                              decode() |                             encode() |
| :---------------------------------- | ------------------------------------: | -----------------------------------: |
| Serde: One Shot                     | 56.57 MiB $({\color{green}-0.00\\%})$ | 119.08 MiB $({\color{red}+0.00\\%})$ |
| Serde: One Shot sans type inference |   60.08 MiB $({\color{red}+0.01\\%})$ |  55.08 MiB $({\color{red}+0.01\\%})$ |
...
| Nat16            |    15_846_460 $({\color{gray}0\\%})$ |    11_244_783 $({\color{gray}0\\%})$ |   3_118_694 $({\color{gray}0\\%})$ |   3_055_002 $({\color{gray}0\\%})$ |
| Nat32            |    16_889_963 $({\color{gray}0\\%})$ |    12_281_710 $({\color{gray}0\\%})$ |   3_295_445 $({\color{gray}0\\%})$ |   3_230_713 $({\color{gray}0\\%})$ |
...
| Float            |    27_007_864 $({\color{gray}0\\%})$ |    22_369_355 $({\color{gray}0\\%})$ |  14_513_119 $({\color{gray}0\\%})$ |  14_441_363 $({\color{gray}0\\%})$ |
| Bool             |    15_206_881 $({\color{gray}0\\%})$ |    10_569_732 $({\color{gray}0\\%})$ |   3_073_661 $({\color{gray}0\\%})$ |   3_017_665 $({\color{gray}0\\%})$ |
| Text             |    19_592_913 $({\color{gray}0\\%})$ |    14_941_915 $({\color{gray}0\\%})$ |   4_009_456 $({\color{gray}0\\%})$ |   3_937_084 $({\color{gray}0\\%})$ |
| Null             |    14_381_365 $({\color{gray}0\\%})$ |     9_638_613 $({\color{gray}0\\%})$ |  17_283_687 $({\color{gray}0\\%})$ |  12_413_571 $({\color{gray}0\\%})$ |
| Empty            |    14_392_824 $({\color{gray}0\\%})$ |     9_643_464 $({\color{gray}0\\%})$ |  17_319_146 $({\color{gray}0\\%})$ |  12_421_422 $({\color{gray}0\\%})$ |
| Principal        |    28_227_213 $({\color{gray}0\\%})$ |    23_564_430 $({\color{gray}0\\%})$ |   5_899_613 $({\color{gray}0\\%})$ |   5_826_985 $({\color{gray}0\\%})$ |
...
| Array(Nat8)      |    45_434_481 $({\color{gray}0\\%})$ |    19_043_366 $({\color{gray}0\\%})$ |   6_388_415 $({\color{gray}0\\%})$ |   4_824_059 $({\color{gray}0\\%})$ |
| Array(Text)      |    70_560_155 $({\color{gray}0\\%})$ |    43_704_230 $({\color{gray}0\\%})$ |  13_914_746 $({\color{gray}0\\%})$ |  12_336_782 $({\color{gray}0\\%})$ |
| Array(Record)    |    75_207_193 $({\color{gray}0\\%})$ |    46_668_309 $({\color{gray}0\\%})$ |  25_851_625 $({\color{gray}0\\%})$ |  12_482_869 $({\color{gray}0\\%})$ |
| Record(Simple)   |    54_929_766 $({\color{gray}0\\%})$ |    35_659_467 $({\color{gray}0\\%})$ |  20_869_156 $({\color{gray}0\\%})$ |  11_872_256 $({\color{gray}0\\%})$ |
| Record(Nested)   |   184_592_815 $({\color{gray}0\\%})$ |   135_436_164 $({\color{gray}0\\%})$ | 119_537_265 $({\color{gray}0\\%})$ |  25_292_120 $({\color{gray}0\\%})$ |
| Tuple(Mixed)     |    64_618_360 $({\color{gray}0\\%})$ |    53_535_427 $({\color{gray}0\\%})$ |  28_659_254 $({\color{gray}0\\%})$ |  14_379_032 $({\color{gray}0\\%})$ |
| Variant(Simple)  |    37_327_726 $({\color{gray}0\\%})$ |    29_396_662 $({\color{gray}0\\%})$ |  36_820_070 $({\color{gray}0\\%})$ |   5_872_002 $({\color{gray}0\\%})$ |
| Variant(Complex) |   121_098_474 $({\color{gray}0\\%})$ |   175_449_881 $({\color{gray}0\\%})$ | 195_597_312 $({\color{gray}0\\%})$ |  17_718_811 $({\color{gray}0\\%})$ |
| Large Text       | 1_123_743_576 $({\color{gray}0\\%})$ | 1_119_099_052 $({\color{gray}0\\%})$ | 271_707_055 $({\color{gray}0\\%})$ | 271_640_971 $({\color{gray}0\\%})$ |
| Large Array      | 1_914_730_224 $({\color{gray}0\\%})$ |   841_831_434 $({\color{gray}0\\%})$ | 258_021_784 $({\color{gray}0\\%})$ | 256_462_957 $({\color{gray}0\\%})$ |
| Deep Nesting     |   139_695_288 $({\color{gray}0\\%})$ |    91_432_721 $({\color{gray}0\\%})$ |  52_562_633 $({\color{gray}0\\%})$ |  18_097_716 $({\color{gray}0\\%})$ |
| Wide Record      |   212_496_701 $({\color{gray}0\\%})$ |   147_936_344 $({\color{gray}0\\%})$ | 128_361_675 $({\color{gray}0\\%})$ |  65_740_966 $({\color{gray}0\\%})$ |
...
| Large Text       | -755.58 KiB $({\color{gray}0\\%})$ |  -6.09 MiB $({\color{gray}0\\%})$ |   6.38 MiB $({\color{gray}0\\%})$ |   6.36 MiB $({\color{gray}0\\%})$ |
...
| Float      | 621_879_809 $({\color{gray}0\\%})$ | 584_630_412 $({\color{gray}0\\%})$ |
...
| Int32      |   6_552_923 $({\color{gray}0\\%})$ |  22_293_501 $({\color{gray}0\\%})$ |
| Int64      |   9_208_249 $({\color{gray}0\\%})$ |  36_347_414 $({\color{gray}0\\%})$ |
| Float      | 614_839_809 $({\color{gray}0\\%})$ | 577_590_412 $({\color{gray}0\\%})$ |
| LEB128_64  | 249_632_291 $({\color{gray}0\\%})$ | 272_364_918 $({\color{gray}0\\%})$ |
| SLEB128_64 | 336_261_565 $({\color{gray}0\\%})$ | 278_411_187 $({\color{gray}0\\%})$ |
...
| Float | 636_687_445 $({\color{gray}0\\%})$ | 622_833_681 $({\color{gray}0\\%})$ |
